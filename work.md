...
간단하게 소개해 드리자면 현 근무하는 회사는 SI 파견업무를 (LG CNS, 판토스) 주로 하며 선사와의( 해상물류, 홈페이지, 여객 시스템 , 기간계시스템연동 등등 ) 사업을 주로하는 본사 솔루션 사업을 하는 기업입니다.

저는 본사 인원으로 근무하고 있으며 저의 role은 eCargo 솔루션 메인으로 eCargo( 해상물류 WEB Booking 시스템 ) 을 맡아 선사별 프로젝트를 진행했습니다. 
최근에는 구성원의 화물 프로그램 , WebServer 관리 서브 role / 여객시스템 main Role 을 맡고 있습니다.
외로는 도재학교인원 교육담당자로 교육진행, 신입사원 본사 교육 등을 진행한 경험이있습니다.
